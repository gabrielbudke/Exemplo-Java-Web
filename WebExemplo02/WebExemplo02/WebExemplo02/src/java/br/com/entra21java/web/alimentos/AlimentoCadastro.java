...
public class AlimentoCadastro extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        out.println("			<input class='form-control' type='text' id='campo-nome' name='nome' required='required' onfocusout='validarCampoNome()'>");
        out.println("		</div>");
        out.println("		<div id='div-campo-quantidade' class='form-group'>");
        out.println("			<label for=''>Quantidade<span class='text-danger font-weight-bold'>*</span></label>");
        out.println("			<input class='form-control' type='text' id='campo-quantidade' name='quantidade' required='required' onfocusout='validarCampoQuantidade()'>");
        out.println("		</div>");
